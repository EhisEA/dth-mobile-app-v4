...
class _CommentComposerState extends State<CommentComposer> {
  ...
  final ValueNotifier<bool> _isTextfieldFocused = ValueNotifier(false);
  @override
  void initState() {
    super.initState();
    _controller.addListener(() {
      ...
      if (has != _hasText || typing != _isTyping) {
        setState(() {
          _hasText = has;
          _isTyping = typing;
        });
    ...
    _focus.addListener(() {
      _isTextfieldFocused.value = _focus.hasFocus;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
      valueListenable: _isTextfieldFocused,
